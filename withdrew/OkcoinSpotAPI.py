...
class OKCoinSpot:
    ...
    #现货提现
    def withdraw(self,symbol,chargefee,trade_pwd,withdraw_address,withdraw_amount):
           ORDER_WITHDRAW_RESOURCE = "/api/v1/withdraw.do"
           params = {
              'api_key':self.__apikey,
              'symbol':symbol,
              'chargefee':chargefee,
           ...
           params['sign'] = buildMySign(params,self.__secretkey)
           return httpPost(self.__url,ORDER_WITHDRAW_RESOURCE,params)
