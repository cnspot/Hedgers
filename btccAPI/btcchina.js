...
BTCChina.prototype.ticker = function(callback) {
  this._marketRequest('ticker', 'market=btccny', callback);
};
...
BTCChina.prototype.getAccountInfo = function(params,callback) {
  this._tradeRequest('getAccountInfo', [params], callback);
  //this._tradeRequest('getAccountInfo', [], callback);
  //this._tradeRequest('getAccountInfo', ["balance"], callback);
};
